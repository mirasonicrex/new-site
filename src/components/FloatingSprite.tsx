...
const FloatingSprite: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Capture the current time to calculate delta for smooth animation
    let lastTime = 0;
    // Scene, camera, and renderer setup
    const scene = new THREE.Scene();
    const camera = new THREE.PerspectiveCamera(75, (window.innerWidth  /6) / window.innerHeight, 0.1, 1000);
 ...
 const amplitude = 0.2; // Control the movement extent
